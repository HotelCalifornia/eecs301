...
def wave():
	...
	setMotorTargetPositionCommand(MOTORS[4], target1_0)
	rospy.sleep(0.1)
	setMotorTargetPositionCommand(MOTORS[4], target1_f)
	rospy.sleep(0.1)
	setMotorTargetPositionCommand(MOTORS[6], target1_0)
	rospy.sleep(0.1)
	setMotorTargetPositionCommand(MOTORS[6], target2_f)
	rospy.sleep(0.1)	
	setMotorTargetPositionCommand(MOTORS[7], target1_0)
	rospy.sleep(0.1)
	setMotorTargetPositionCommand(MOTORS[7], target1_f)
	rospy.sleep(0.1)
	setMotorTargetPositionCommand(MOTORS[5], target1_0)
	rospy.sleep(0.1)
	setMotorTargetPositionCommand(MOTORS[5], target2_f)
...
if __name__ == "__main__":
	...
	while not rospy.is_shutdown():
		if getSensorValue(2) != 0:
			rotate()
		elif 700 <= getSensorValue(1) <= 1000:
			wave()
